...
output_path = "./Tests/Output/random_image_gray_bgv.jpg"
...
# Konfiguracja Pyfhel dla BGV
HE = Pyfhel()

# Parametry kontekstu
context_params = {
    'scheme': 'BGV',        # Schemat BGV
    'n': 2**15,             # Stopień wielomianu
    't': 2**60,             # Moduł plaintext
    'scale': 2**40,         # Skala
    'qi_sizes': [60, 40, 40, 60]  # Rozmiary moduli współczynników
}

HE.contextGen(**context_params)
HE.keyGen()
